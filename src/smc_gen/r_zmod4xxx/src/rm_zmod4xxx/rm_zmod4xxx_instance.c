...
/**********************************************************************************************************************
 Macro definitions
 *********************************************************************************************************************/
#define FUNC(x, y, z)      R_ ## x ## y ## z
#define XSTART(x, y)    FUNC(x, y, _Start)
#define XSTOP(x, y)     FUNC(x, y, _Stop)
...
{
	.p_start    = XSTART(RM_ZMOD4XXX_CFG_INTC, RM_ZMOD4XXX_CFG_DEVICE0_IRQ_NUMBER),
	.p_stop     = XSTOP(RM_ZMOD4XXX_CFG_INTC, RM_ZMOD4XXX_CFG_DEVICE0_IRQ_NUMBER),
};
#endif
