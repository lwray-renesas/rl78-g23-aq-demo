...
#define DISPLAY_OFFSET_TUNING_CW	(0x040000UL)
#define DISPLAY_COUNTDOWN			(0x080000UL)
#define DISPLAY_TUNING_ELIPSE		(0x100000UL)
#define DISPLAY_SUCCESS				(0x200000UL)
#define DISPLAY_OFFSET_TUNING_CCW	(0x400000UL)
#define DISPLAY_OFFSET_TUNING_CLICK	(0x800000UL)
#define	ALL_GUI_EVENTS				(0xFFFFFFUL)
